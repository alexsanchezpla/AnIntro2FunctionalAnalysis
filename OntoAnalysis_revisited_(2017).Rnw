...
\usepackage{a4wide}
\usepackage{setspace}
\usepackage{amsmath}                                                                                        %% Est?ndar %%
\usepackage{amsthm}                                                                  %% Estils de definici? d'enunciats %%
\usepackage{amssymb}                                                                                         %% S?mbols %%
\usepackage{hyperref}
\usepackage{moreverb}
\usepackage{array}   % Opcions addicionals per arrays i alineaci? en columnes %%
...
% La versio original d'aquestes notes es troba a l'arxiu "OntoAnalysis. Rnw"
...
Inside the annotation package there are several lists of links relating probe-id's with different databases or between each other.?
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% COMPTE
% El que fa codi de sota es pot fer MOLT MES FACILMENT !!!
% select(org.Hs.eg.db, keys=commonGene, columns = c("SYMBOL","ONTOLOGY"))
% select(org.Hs.eg.db, keys=commonGene, columns = c("SYMBOL","GO"))
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
require(hgu95av2.db)
require(Rgraphviz)
genes<-as.character(read.table("datasets/End2EndProbelist.txt")$V1)
